<template>
  <div>
		<f7-navbar ref="navbar" title="Appbar" back-link="Back"></f7-navbar>
    <f7-appbar>
      <div class="left">
        <f7-button small panel-toggle="left" class="display-flex" icon-f7="bars"></f7-button>
        <f7-button small class="display-flex margin-left-half" icon-f7="reply_fill"></f7-button>
        <f7-button small class="display-flex margin-left-half" icon-f7="forward_fill"></f7-button>
      </div>
      <div class="right">
        <f7-searchbar
          inline
