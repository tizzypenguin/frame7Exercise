<template>
  <f7-page>
    <f7-navbar ref="navbar" title="Login Screen" back-link="Back"></f7-navbar>
    <f7-block>
    ...
    <f7-list>
      <f7-list-item link="/login-screen-page/" title="As Separate Page" @click="alert('my app is not use router')"></f7-list-item>
    </f7-list>
